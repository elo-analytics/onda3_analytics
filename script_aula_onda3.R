...
sus_do_df_2013 <- read_excel("sus_do_df_2013.xlsx")
sus_do_df_2013

sus_sih_df_2013 <- read_excel("sus_sih_df_2013.xlsx")
sus_sih_df_2013
...
head(ordena_desc_idade$IDADEanos)
...
#write_csv(dados, "dados_geo_sus_do.csv")

dados_geo_sus_do <- read_csv("dados_geo_sus_do.csv")
require(leaflet)
